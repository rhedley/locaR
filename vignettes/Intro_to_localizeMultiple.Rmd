...
This can all be set up easily using the `setupSurvey()` function:

```{r}
survey <- setupSurvey(folder = getwd(), projectName = 'Ex', run = 1,
...
dets <- read.csv(system.file('data', 'Vignette_Detections_20200617_090000.csv', package = 'locaR'))

#over-write empty detections file.
write.csv(dets, './20200617_090000/Run1/Ex_20200617_090000_Run1_Detections.csv', row.names = F)
```
